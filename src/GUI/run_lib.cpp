...
QLibrary mydll("Dll1.dll");

typedef int (*myRun)(int argc, char** argv);
typedef int (*myRun2)();
...
run_lib::run_lib() {
    ...
    mydll.load();
    run = (myRun)mydll.resolve("run");
    run2 = (myRun2)mydll.resolve("run2");
...
int run_lib::run3(int argc, char** argv) {
        //int result2 = run2();
        //return result2;
